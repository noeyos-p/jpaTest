...
public interface UsersRepository extends JpaRepository<Users, Long> {
    ...
    // Contains : 포함된 자료
    // Like : 사용 시 넘겨주는 인자 값 양쪽에 %를 붙어주어야 함
    ...
    // 잠깐 퀴즈
    // Orange 색상 중 Gender의 오름차순 생성자, CreatedAt에 내림차순 후 상위 10개 검색
